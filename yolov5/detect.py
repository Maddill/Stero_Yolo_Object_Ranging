...
def run(weights=ROOT / 'best.pt',  # model.pt path(s)
        source1=1,  # file/dir/URL/glob, 0 for webcam
        source2=2,
    ...
    if webcam:
        ...
        dataset = LoadStreams([source1, source2], img_size=imgsz, stride=stride, auto=pt)
        bs = len(dataset)  # batch_size
    else:
        dataset = LoadImages([source1, source2], img_size=imgsz, stride=stride, auto=pt)
        bs = 1  # batch_size
...
def parse_opt():
    ...
    parser.add_argument('--source1', type=str, default=1, help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--source2', type=str, default=2, help='file/dir/URL/glob, 0 for webcam')
